    ...
    <div class="input-group mb-3">
        <div class="input-group-prepend">
          <div class="input-group-text">
            <input type="number" class="voteForItem" min="0" max="20"
...
$('#submit').click(function () {
    ...
    for(var i = 0; i < chkArray.length; i++){
        ...
        contractInstance.addNote(chkArray[i], {from: web3.eth.accounts[0] , gas: 3000000}, function(err, res){
            if(err) console.log(err);
            console.log(res);
...
contractInstance.getExams.call({ from: web3.eth.accounts[0], gas: 3000000 },
    function (err, res) { 
        arr = res;
        showHashes(res)
